...
class TestEnsureNanobotAgent:
    @patch("mc.agent_sync._fetch_bot_identity", return_value={"name": "Owl", "role": "General-Purpose Assistant"})
...
class TestSyncAgentRegistryNanobotAgent:
    def test_sync_includes_nanobot_agent_with_is_system_true(self, tmp_path: Path) -> None:
        ...
        with patch("mc.agent_sync._cleanup_deleted_agents"), patch(
            "mc.agent_sync._write_back_convex_agents"
        ):
