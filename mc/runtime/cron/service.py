...
from mc.runtime.cron.types import CronJob, CronJobState, CronPayload, CronSchedule, CronStore
...
def _parse_raw_job(j: dict) -> CronJob:
    """Parse a job dict that may be in old flat or new nested camelCase format."""
    # --- schedule ---
