...
class MappingService:
    ...
    def get_mc_task_id(self, config_id: str, external_id: str) -> str | None:
        ...
        mapping = self._bridge.get_integration_mapping_by_external(
            config_id,
            "issue",
            external_id,
        )
    ...
    def get_external_id(self, config_id: str, mc_task_id: str) -> str | None:
        ...
        mapping = self._bridge.get_integration_mapping_by_internal(
            config_id,
            "task",
            mc_task_id,
        )
    ...
    def get_mapping_for_task(self, mc_task_id: str) -> dict[str, Any] | None:
        ...
        mappings = self._bridge.get_integration_mappings_by_internal_id(mc_task_id)
