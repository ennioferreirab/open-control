...
class LiteLLMProvider(LLMProvider):
    ...
    async def chat(
        ...
        Args:
            ...
            reasoning_effort: Upstream param (low/medium/high) passed to provider.
            reasoning_level: MC alias for reasoning (low/medium/max), translated to provider params.
        ...
        effective_level = reasoning_level or reasoning_effort
        if effective_level:
            ...
            if "anthropic" in model_lower or "claude" in model_lower:
                ...
                # Upstream reasoning_effort passthrough for other providers
                if reasoning_effort:
